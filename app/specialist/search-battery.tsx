...
import SearchBatteryForm from "./search-battery-form";
  ...
  return (
    <>
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Search battery passport</DialogTitle>
          </DialogHeader>
          <SearchBatteryForm />
        </DialogContent>
      </Dialog>
