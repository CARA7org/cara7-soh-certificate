...
export default function AddEventForm({
  ...
  const onSubmit = async (values: EventFormSchema) => {
    ...
    try {
      ...
      const totalCost = estimatedGas * gasPrice * BigInt(10);
              ...
              <FormControl>
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="raw materials percent">
                      Raw materials percentage
                    </SelectItem>
                    <SelectItem value="tracability">Tracability</SelectItem>
                    <SelectItem value="states life cycle">
                      States life cycle
                    </SelectItem>
                  </SelectContent>
                </Select>
